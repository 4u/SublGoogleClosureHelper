...
binfile = os.path.abspath(os.path.join(os.path.dirname(__file__), 'closure-helper', 'bin'))
binfile = string.replace(binfile, ' ', '\\ ')
    ...
    def run(self, edit):
        ...
        for region in view.sel():
            ...
            if region.empty():
                ...
                cmd = binfile + '/createmethod -f \"' + filename + '" -c "' + string.replace(lineContents, '"', '\\"') + '"'
